...
const ReadBookCard = ({ readBook }) => {
    ...
    return (
        <div className='flex items-center gap-6 mb-5 border border-[#13131326] rounded-2xl p-4'>
            <div className='w-1/5 bg-[#1313130D] rounded-2xl'>
            ...
            <div className='w-4/5'>
                ...
                <div className='flex items-center gap-3 my-3 text-[#23BE0A]'>
                ...
                <div className='flex items-center gap-5 text-xs text-[#13131399] font-semibold border-b border-[#13131326] pb-3 mb-3'>
                ...
                <div className='flex items-center text-xs font-semibold gap-5'>
